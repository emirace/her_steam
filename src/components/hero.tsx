    ...
    >
      ...
      <div className="md:w-3/5 text-white relative z-20 ">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <button className="bg-gradient-to-r from-blue-400 to-purple-400 p-0.5 rounded-full font-bold text-lg">
          ...
          <button className="bg-gradient-to-r from-blue-400 to-purple-400 px-6 py-3 rounded-full font-bold text-lg">
            Join the Initiative
          </button>
        </div>
      </div>
